mainFolder = 'C:\Users\cis\Documents\Lung cancer\All Daata\New folder';
savefolder = 'C:\Users\cis\Documents\Lung cancer\PNG'
...
for K = 1: numberOfFolders
    ...
    for J= 1: numberOfsubFolders
        ...
        for L= 1: numberOfsubsubFolders
            ...
            filenames(tf) = [];
            filenames1 = dir(strcat(subsubsubdirpath, '\*.dcm'))
