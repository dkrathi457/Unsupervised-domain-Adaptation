function [kl, dist, prediction, acc,G] = MyGFK(X_src,Y_src,X_tar,Y_tar,dim)
    % Inputs:
    ...
    [kl,dist, prediction, acc] = my_kernel_knn(G, X_src, Y_src, X_tar, Y_tar);
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [kl,dist, prediction,accuracy] = my_kernel_knn(M, Xr, Yr, Xt, Yt)
