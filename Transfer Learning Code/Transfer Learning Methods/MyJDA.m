function [Y_tar_pseudo,score,acc,acc_ite,A] = MyJDA(X_src,Y_src,X_tar,Y_tar,options)
    % Inputs:
	...
	for i = 1 : T
        ...
        knn_model = fitcknn(Zs',Y_src,'NumNeighbors',2);
        [Y_tar_pseudo,score]  = knn_model.predict(Zt');
